      ...
      <main className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
              <div className="space-y-4 md:space-y-5 lg:space-y-6 order-1 md:order-1">
                <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
                  <span className="text-blue-600">Apart Hotel</span> Premium en Cariló
                </h1>
                ...
                <div className="pt-2 md:pt-3 lg:pt-4">
                  ...
                  >
                    Reservar Apart Hotel <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </div>
              </div>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <Hotel className="h-5 w-5 mr-3 mt-1 text-blue-600 flex-shrink-0" />
                  <div>
                    <p className="text-lg">
                ...
                <li className="flex items-start">
                  <Coffee className="h-5 w-5 mr-3 mt-1 text-orange-600 flex-shrink-0" />
                  <div>
                    <p className="text-lg">
                ...
                <li className="flex items-start">
                  <Shield className="h-5 w-5 mr-3 mt-1 text-green-600 flex-shrink-0" />
                  <div>
                    <p className="text-lg">
                ...
                <li className="flex items-start">
                  <Car className="h-5 w-5 mr-3 mt-1 text-red-600 flex-shrink-0" />
                  <div>
                    <p className="text-lg">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-5 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-start mb-3">
                  <Hotel className="h-5 w-5 mr-3 mt-1 text-blue-600" />
                  <div>
              ...
              <div className="bg-white p-5 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-start mb-3">
                  <MapPin className="h-5 w-5 mr-3 mt-1 text-purple-600" />
                  <div>
                    <h3 className="text-lg font-semibold">
                      Ubicación Exclusiva
                    </h3>
              ...
              <div className="bg-white p-5 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-start mb-3">
                  <Star className="h-5 w-5 mr-3 mt-1 text-yellow-600" />
                  <div>
                    <h3 className="text-lg font-semibold">
                      Calidad 5 Estrellas
                    </h3>
        ...
        <section className="py-16 bg-blue-600 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              Reservar Apart Hotel <ArrowRight className="ml-2 h-5 w-5" />
            </Link>
          </div>
        </section>
      </main>
