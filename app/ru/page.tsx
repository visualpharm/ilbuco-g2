  ...
  const heroImages = [
    {
      ...
      alt: "Современная вилла IL BUCO с тёплым освещением в сосновом лесу"
    }
  ]
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <Image src="/icons/icons8/tree.svg" alt="" width={24} height={24} className="mr-3 mt-1 flex-shrink-0" style={{filter: 'brightness(0) saturate(100%) invert(40%) sepia(1%) saturate(1042%) hue-rotate(314deg) brightness(94%) contrast(80%)'}} />
                  <div>
                    <p className="text-lg">
                ...
                <li className="flex items-start">
                  <Image src="/icons/icons8/utensils.svg" alt="" width={24} height={24} className="mr-3 mt-1 flex-shrink-0" style={{filter: 'brightness(0) saturate(100%) invert(40%) sepia(1%) saturate(1042%) hue-rotate(314deg) brightness(94%) contrast(80%)'}} />
                  <div>
                    <p className="text-lg">
                ...
                <li className="flex items-start">
                  <Image src="/icons/icons8/tennis-racquet.svg" alt="" width={24} height={24} className="mr-3 mt-1 flex-shrink-0" style={{filter: 'brightness(0) saturate(100%) invert(40%) sepia(1%) saturate(1042%) hue-rotate(314deg) brightness(94%) contrast(80%)'}} />
                  <div>
                    <p className="text-lg">
                ...
                <li className="flex items-start">
                  <Image src="/icons/icons8/house.svg" alt="" width={24} height={24} className="mr-3 mt-1 flex-shrink-0" style={{filter: 'brightness(0) saturate(100%) invert(40%) sepia(1%) saturate(1042%) hue-rotate(314deg) brightness(94%) contrast(80%)'}} />
                  <div>
                    <p className="text-lg">
                ...
                <li className="flex items-start">
                  <Image src="/icons/icons8/target.svg" alt="" width={24} height={24} className="mr-3 mt-1 flex-shrink-0" style={{filter: 'brightness(0) saturate(100%) invert(40%) sepia(1%) saturate(1042%) hue-rotate(314deg) brightness(94%) contrast(80%)'}} />
                  <div>
                    <p className="text-lg">
        ...
        <section className="bg-gray-50 py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-5 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <Link href="/ru/the-house" className="flex items-start mb-3 group">
              ...
              <div className="mb-6">
                <div className="relative w-full max-w-md mx-auto">
                  <Image
                    ...
                    alt="Тест скорости Fast.com показывает 350 Мбит/с"
                    width={600}
                    height={400}
                    className="mx-auto"
                  />
                ...
                <div className="md:col-span-3">
                  <div className="relative h-[400px] rounded-xl overflow-hidden">
                    <Image
                      ...
                      alt="Расслабляющий вид из IL BUCO"
                      fill
