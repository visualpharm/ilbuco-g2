                ...
                <ul className="space-y-6">
                  ...
                  <li className="relative">
                    <div className="flex items-start">
                      <span className="text-2xl mr-3 mt-0.5 flex-shrink-0" style={{filter: 'grayscale(100%) brightness(0.6)'}}>🚌</span>
                      <div>
                        <p className="font-semibold">
                  ...
                  <li className="flex items-start">
                    <span className="text-2xl mr-3 mt-0.5 flex-shrink-0" style={{filter: 'grayscale(100%) brightness(0.6)'}}>✈️</span>
                    <div>
                      <p className="font-semibold">
