...
export function PlacesNearbyActivitiesContent() {
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-4xl md:text-5xl font-bold mb-8 text-center">
                <Translate text={{
                  en: "Activities & Sports Near Cariló",
                  es: "Actividades y Deportes en Cariló",
                  pt: "Atividades e Esportes em Cariló"
                }} />
              </h1>
                  ...
                  <h2 className="text-3xl font-bold mb-4">
                    <Translate
                      text={{
                        ...
                        pt: "Atividades e Serviços Próximos"
                      }}
                    />
                  </h2>
                  <p className="text-lg text-gray-700">
                    <Translate
                      text={{
                        ...
                        pt: "Todos os destinos estão a 25–35 minutos caminhando ou uma curta viagem de carro do Il Buco."
                      }}
                    />
                  </p>
                </div>
